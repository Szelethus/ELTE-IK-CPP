...
\end{lstlisting}
	...
	\begin{figure}[t]
		...
		Az \texttt{std::set} egy lehetséges ábrázolása, bináris keresőfával. Erre az irányított gráfra igaz, hogy minden gyökér a bal oldali gyerekénél nagyobb, és a jobb oldali gyerekénél kisebb.
	\end{figure}
	\subsection{list}
