...
int main()
{
	...
	Írjunk egy funktort, mely egész számok számokat növekvő sorrendbe rendez.
	\begin{lstlisting}
...
int main()
{
	...
	Az \texttt{std::set} a \texttt{<set>} könyvtárban található. Ez a konténer a matematikai halmazt valósítja meg: egyedi elemeket tárol, és ha egy olyan elemt próbálnánk beszúrni, mellyel ekvivalens már szerepel a \texttt{set}-ben, nem történne semmi (\textit{no-op}). 
