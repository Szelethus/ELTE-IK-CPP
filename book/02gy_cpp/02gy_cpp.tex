...
*p = 7;
	...
	\begin{figure}[!h]
		\centering
		\input{stack_pointer_intro.tikz}
...
void f(int t[]) { std::cout << sizeof(t) << std::endl; }
...
int main() {
  ...
  f(t);
	...
	\begin{lstlisting}
void f(int t[8]) { std::cout << sizeof(t) << std::endl; }
	\end{lstlisting}
...
int main() {
  ...
  f(t, sizeof(t) / sizeof(t[0]));
	...
	\begin{lstlisting}
void g(int (*t)[5]) { std::cout << sizeof(t) << std::endl; }
	\end{lstlisting}
