...
\begin{document}
	...
	\section{Előszó}
	Ez a jegyzet az ELTE IK hallgatóinak készült a Programozási Nyelvek: C++ c. tárgyhoz. A jegyzet segítségével a gyakorlaton és előadáson elhangzott anyagok mélyebben elsajátíthatóak, néhány helyen hiányos jegyzetet jól kiegészít. Merjük gondolni, hogy az, aki a jegyzetben leírtakat mind magas szinten megérti, az olvasás mellé a példakódokat lefuttatja és módosításokkal kitapasztalja azok működését, az jó eséllyel a vizsgán (különösképpen a gyakorlati részén) nem fog sikertelenül távozni.
	
	Azonban a jegyzet \textbf{nem 100\%-ban fedi le az előadás és gyakorlat anyagát.} Ez azt jelenti, hogy ahhoz, hogy a tárgyat valaki (garantáltan) négyesre vagy jobbra teljesítse, az előadáson és gyakorlaton megszerzett tudásokra is szüksége lesz. Példaképp, valamennyi programozási konvenció, a programozási nyelvek történelme, és még megannyi dolog nem szerepel a jegyzetben, és később se fog, azonban ezeknek az ismerete mindenképpen fontos és elvárható egy programtervező informatikustól.
	
	\smallskip
	Kihangsúlyozandó, hogy a jegyzet elsősorban a vizsga előtti felkészülésre íródott, így a vizsgán szükséges gyakorlat nélkül önmagában nem elég.
...
int main()
{
	...
	\end{lstlisting}
	A fájl maga, \texttt{main.cpp}, egy \textbf{fordítási egység} (\textit{compilation unit}). Fordításkor fordítási egységeket fordítunk gépi kódra.
