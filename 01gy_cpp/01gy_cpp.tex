...
int main()
{
	...
	\begin{center}
		\begin{tikzpicture}
		\tikzstyle{Node} = [rectangle, minimum width=3cm, minimum height=5mm, text centered, draw=black, fill= gray!20]
		\tikzstyle{FileName} = [rectangle, minimum width=3cm, minimum height=5mm, text centered, draw=black, fill= white]
		\tikzstyle{NodeExe} = [rectangle, minimum width=4cm, minimum height=5mm, text centered, draw=black, fill= gray!20]
		\tikzstyle{FileNameExe} = [rectangle, minimum width=4cm, minimum height=5mm, text centered, draw=black, fill= white]
		...
		\node (exe) [NodeExe, below = 5.8 cm of header] {Végrehajtható állomány};
...
#undef KORTE
	...
	%A kimenetben viszont a megfelelő direktívákból visszaállítható az eredeti sorszám. what???
	\begin{note}
...
int main()
{
	...
	\fbox{\textbf{fecske.h}}
	%a függvény csak az átláthatóság végett lett bejjebb húzva
	\begin{lstlisting}
#ifndef _FECSKE_H_
#define _FECSKE_H_
	void fecske();
