...
\lstdefinestyle{customc}{
	...
	emph = {std, A, B, Base, BaseOne, BaseTwo, C, CharT, Circle, ConstIterator, D, Deltoid, Derived, Derived2, DerivedLast, DerivedOne, DerivedTwo, Fact, Fiu, Foo, Greater, Hallgato, Iterator, Kor, Lany, Less, LessByX, LinAlgVector, List, Matrix, Negyszog, Negyzet, Rombusz, S, Sielo, Sikidom, StringLength, T2, Templ, U, Val, X, Y, Z, deque, iterator_category, line_editor, list, map, multimap, multiset, pair, set, string, strlen, strlenWrong, vector},
