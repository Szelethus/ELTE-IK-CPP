...
\end{lstlisting}
	Itt a kiírató operátorunk miatt nem fog fordulni a kódunk! A \texttt{ConstIterator} egy un. \textbf{dependent scope}-ban lesz (ld. 7. gyakorlat).
