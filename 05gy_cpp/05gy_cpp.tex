...
printFirstElement(List(4)); //a lista élettartama a függvényhívástól a függ-vény futásának végéig tart.
	...
	\end{note}
	\begin{note}
		A temporális változók jobb értékek, így csak konstans referenciával, vagy érték szerint tudjuk őket átvenni. Ha konstans referenciához kötjük, akkor a változó élettartama kiterjesztésre kerül, meg fogy egyezni a referencia élettartamával.
	\end{note}
